...
import pheninux.xdev.gestork.web.table.view.TableViewController;
...
class TableViewControllerTest {
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(tableViewController).build();
    }
    ...
    void testShowAssignTablesPage() throws Exception {
        ...
        mockMvc.perform(get("/view/table/assign"))
