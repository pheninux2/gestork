...
public class ApiController {
    ...
    public ApiController(AccessCodeService accessCodeService, CustomerRepository customerRepository, BCryptPasswordEncoder passwordEncoder, DishRepository dishRepository) {
