...
public class CodeApiController {
    ...
    public ResponseEntity<String> generate(@RequestParam("clientLogin") String clientLogin, @RequestParam("tableNumber") int tableNumber, HttpServletResponse response) {
        if (!isAdmin() && !isWaiter()) {
